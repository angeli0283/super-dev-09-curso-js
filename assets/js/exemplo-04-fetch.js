function cadastrarEmpresa(){
    // URL que será chamada do baxk-end
    ...
    fetch(url, {
        ...
        body: JSON.stringify(dados) // converte de objeto(dicionário) para string
    })
        .then(response => response.json()) // converte de string para objeto
        .then(dado => {
